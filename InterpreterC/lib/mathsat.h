/* -*- C -*-
 * 
 * MathSAT5 is copyrighted 2009-2012 by FBK-IRST, Italy, University of Trento,
 * Italy, and others. All rights reserved.
 * 
...
typedef enum {
    ...
    MSAT_TAG_FP_AS_BV,      /**< FP as BV (access to the bits) */
 ...
 *         ::MSAT_ERROR_TERM(t) is true in case of errors.
 */
msat_term msat_make_fp_to_bv(msat_env e, size_t width, msat_term t);
 ...
 *         ::MSAT_ERROR_TERM(t) is true in case of errors.
 */
msat_term msat_make_fp_as_bv(msat_env e, msat_term t);
 ...
 */
int msat_term_is_fp_as_bv(msat_env e, msat_term t);
